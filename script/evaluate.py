...
if __name__ == "__main__":
    file_gt_sens_poses = "/media/zz/new/myMidImg/kitti_06/out.txt"

    file_outcome_osk = "/media/zz/new/myMidImg/search_result/kitti_06.txt"
    ...
    pr_results = [
        ...
        pr.comput_pr_points(file_gt_sens_poses, iris_result, thres_dist, thres_time),
